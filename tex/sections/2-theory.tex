...
\todo[inline]{Wording and sentence structure not super clear in this paragraph.}
...
\begin{definition}[Shape]
  ...
  \todo[inline]{Is this clear?}
\end{definition}


\section{The Elastic Full Procrustes Distance for Planar Curves}
\label{theo:dist}
\todo[inline]{Rewrite motivation. Make approach to derivation more clear.}
...
\begin{figure}
  ...
  \begin{subfigure}{.48\textwidth}
    \centering
    \missingfigure{Example SRV and coordinate functions}
  \end{subfigure}\hfill%
  \begin{subfigure}{.48\textwidth}
    \centering
    \missingfigure{Example reparameterized SRV and coordinate functions}
  \end{subfigure}
...
\begin{figure}
  ...
  \begin{subfigure}{.48\textwidth}
    \centering
    \missingfigure{Example original Procrustes fits}
  \end{subfigure}\hfill%
  \begin{subfigure}{.48\textwidth}
    \centering
    \missingfigure{Example SRV Procrustes fits}
  \end{subfigure}
