...
Finally, \cref{sec:4-tounges} applies the proposed methods to an empirical dataset of tongue shapes, which was kindly provided by \todo{Phonetics Data Citations}\dots.
...
See Figure \cref{fig:4-outliers} \dots \todo{Outlier diskutieren}
...
\section{Analysis of Tongue Shape Variability}
\label{sec:4-tounges}
...
While there is earlier work on functional data approaches to tongue shape analysis \todo{Cite}, these approaches did not account for shape invariance in their estimation and are mostly focused on regression based approaches.
