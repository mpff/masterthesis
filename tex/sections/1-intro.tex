...
Secondly, \cite{SrivastavaEtAl2011} introduced a mathematical framework for the \emph{elastic} (re-parameterisation invariant) shape analysis of curves, by using their square-root-velocity (SRV) representations.
...
\begin{figure}
  ...
  \label{fig:1-mean}
\end{figure}
The later will be achieved by generalising the concept of the full Procrustes mean from landmark to functional data and by iteratively applying full Procrustes mean estimation, rotation-alignment and parameterisation-alignment, leading to the estimation of elastic full Procrustes means.
